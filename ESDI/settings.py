"""
Django settings for ESDI project.
...
SECRET_KEY = '9z6e_maz4u&3&+8b9)#!xt+txwyiy%!oy%uobahq7o(em#9u65'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ADMINS = [('Mahdi Bolow', 'boolow5@gmail.com'),]
...
WSGI_APPLICATION = 'ESDI.wsgi.application'
